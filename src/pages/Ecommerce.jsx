...
import { StackedChart, PieChart, Button , SparkLine } from "../componenets";
          ...
          <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3  p-4 rounded-2xl md:w-780 ">
            ...
            <div className="flex mt-10 gap-10 flex-wrap justify-center ">
              <div className="border-r-1 border-color m-4 pr-10">
                ...
                <div>
                  <p className="">
                    <span className="text-3xl font-semibold">$48,987</span>
                  </p>
                  ...
                  <div className="mt-5">
                    <SparkLine
                     currentColor={currentColor} id="line-sparkline"
                     type="Line"
                     height="80px"
                     width="250px"
